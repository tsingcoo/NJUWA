...
#ifndef GENALIGNPYCALL_INFER_ALIGN_H
#define GENALIGNPYCALL_INFER_ALIGN_H
...
class InferAlign{
public:
    int ReadTTable(char* inputFile1){
    ...
    int ReadCorpusIndexCh(char* inputFile1){
        std::string inputFile = inputFile1;
        std::ifstream fin(inputFile);
        std::string line;
        std::string index;
    ...
    int ReadCorpusIndexEn(char* inputFile1){
        std::string inputFile = inputFile1;
        std::ifstream fin(inputFile);
        std::string line;
        std::string index;
    ...
    virtual int OutputAlign(std::string outputFile){
...
//                     << index_word_en_[corpus_index_en_[i][j]] << "(" << viterbi_alignment_prop[j] << ")";
    ...
    int ReadMyVcbCh(char* inputFile1){
        std::string inputFile = inputFile1;
        std::ifstream fin(inputFile);
        std::string line;
        int index;
    ...
    int ReadMyVcbEn(char* inputFile1){
        std::string inputFile = inputFile1;
        std::ifstream fin(inputFile);
        std::string line;
        int index;
...
#endif //GENALIGNPYCALL_INFER_ALIGN_H
